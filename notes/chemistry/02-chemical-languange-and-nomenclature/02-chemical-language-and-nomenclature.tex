...
\section{Elements and Chemical Symbols}
	...
	\begin{workedexample}[: average atomic mass of chlorine]
		Chlorine occurs naturally as $^{35}\mathrm{Cl}$ ($m = \SI{34.969}{u}$, ${f = 0.7576}$) and $^{37}\mathrm{Cl}$ ($m = \SI{36.966}{u}$, ${f = 0.2424}$). Then
		\begin{equation}
			A_r(\mathrm{Cl}) = (0.7576)(34.969) + (0.2424)(36.966) = 35.45\ \mathrm{u},
		\end{equation}
